...
===================  ==================  =====================================================================================================================================================  ==========================================================================================================================
Data                 generate_data       Synthesized data generation; normal data is generated by a multivariate Gaussian and outliers are generated by a uniform distribution                  :func:`pyod.utils.data.generate_data`
Stat                 wpearsonr           Calculate the weighted Pearson correlation of two samples                                                                                              :func:`pyod.utils.stat_models.wpearsonr`
Utility              get_label_n         Turn raw outlier scores into binary labels by assign 1 to top n outlier scores                                                                         :func:`pyod.utils.utility.get_label_n`
Utility              precision_n_scores  calculate precision @ rank n                                                                                                                           :func:`pyod.utils.utility.precision_n_scores`
===================  ==================  =====================================================================================================================================================  ==========================================================================================================================
