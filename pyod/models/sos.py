...
class SOS(BaseDetector):
    ...
    eps : float, optional (default = 1e-5)
        Tolerence threshold for floating point errors.
    ...
    Janssens, J., Huszar, F., Postma, E., & van den Herik, H. 
    Stochastic Outlier Selection. Technical Report TiCC TR 2012-001, 
    Tilburg University, Tilburg, the Netherlands, 2012.
    """
    
    def __init__(self, contamination=0.1, perplexity=30, metric='euclidean', eps=1e-5):
