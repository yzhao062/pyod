    ...
    def fit(self, X, y=None):
        ...
        for epoch in range(self.stop_epochs * 3):
            ...
            for index, real_data in enumerate(loader):
                print(f'Testing for epoch {epoch + 1} index {index + 1}:')  # Added print statement
                ...
                print(f'Epoch {epoch + 1}/{self.stop_epochs * 3}, Batch {index + 1}/{len(loader)}, Loss_D: {d_loss.item()}, Loss_G: {g_loss.item()}')
