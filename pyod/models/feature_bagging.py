...
class FeatureBagging(BaseDetector):
    ...
    Finally, the prediction score is generated by averaging/taking the
    maximum of all base detectors. See :cite:`lazarevic2005feature` for
    details.

    :param base_estimator: The base estimator to fit on random subsets of
        the dataset. If None, then the base estimator is a LOF detector.
    :type base_estimator: object or None, optional (default=None)

    :param n_estimators: The number of base estimators in the ensemble.
    :type n_estimators: int, optional (default=10)
    ...
    :param max_features: The number of features to draw from X to train
        each base estimator.
    ...
    :param combination: the method of combination:
    ...
    :type estimator_params: dict, optional (default=None)
