...
class RGraph(BaseDetector):
    ...
    Parameters
    ----------
    transition_steps : int, optional (default=10)
    ...
    support_init : {'L2', 'knn'}, optional (default='L2')
        Method used to initialize the active support.

    support_size : int, optional (default=100)
        Size of the active support working set.

    maxiter : int, optional (default=40)
        Maximum number of active support updates.
