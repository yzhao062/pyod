...
class XGBOD(BaseDetector):
    ...
    nthread : int or None, optional (default=None)
        Deprecated alias for ``n_jobs`` passed to XGBoost.
    ...
    labels_ : numpy array of shape (n_samples,)
        The binary labels predicted for the training data by the fitted
        XGBoost classifier. 0 stands for inliers and 1 for
        outliers/anomalies.
