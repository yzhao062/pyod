...
class DummyDetector(BaseDeepLearningDetector):
    def __init__(self, contamination=0.1, epoch_num=1, optimizer='adam', 
                 loss_func=None, criterion='mse', verbose=1, 
                 preprocessing=True, use_compile=False):
...
class TestBaseDL(unittest.TestCase):
    ...
    def test_init(self):
        ...
        dummy_clf = DummyDetector(criterion='mae')
