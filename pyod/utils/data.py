...
def generate_data_clusters(n_samples=100, test_size=0.25, n_clusters=2, n_features=2,
    ...
    for i in range(n_clusters):
        ...
        outliers.append(make_blobs(n_samples=n_outliers_[i], centers=1,
                                   cluster_std=random_state.uniform(clusters_density[i]*(1.), clusters_density[i]*(1.+dist), size=(1,)[0]),
                                   center_box=(-center_box[i], center_box[i]), n_features=n_features, random_state=random_state)[0])
