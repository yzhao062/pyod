...
class LinearBlock(nn.Module):
    ...
    **kwargs
        Additional keyword arguments for activation function and initialization.
        See function `get_activation_by_name` and `init_weights` for details.
    """
    def __init__(self, in_features, out_features,
        ...
        if has_act:
            self.activation = get_activation_by_name(activation_name, inplace=inplace)
        ...
        init_weights(self.linear, init_type=init_type, **kwargs)
